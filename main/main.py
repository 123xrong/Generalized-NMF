...
def main(m, r, n_k, K, sigma=0.0, random_state=None, max_iter=50):
    ...
    accuracy, reconstruction_error, neg_prop= coneClus_iterative(
        X, K, r, true_labels, max_iter=max_iter, random_state=random_state
    )
...
if __name__ == "__main__":
    ...
    main(m, r, n_k, K, sigma=sigma, random_state=random_state, max_iter=max_iter)
